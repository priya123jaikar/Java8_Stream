...
public class FlatMapDemo1 {
    public static void main(String[] args) {
        ...
        List<List<Integer>> finalllist = Arrays.asList(lst1,lst2,lst3);
        List<Integer> finalresults = finalllist.stream().flatMap(x->x.stream().map(n->n+10)).collect(Collectors.toList());
